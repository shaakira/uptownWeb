            ...
            <div class="col-sm-12 section-t8">
                <div class="row">
                    ...
                    <div class="col-md-7" id="about">
                        <p style="font-size: 24px ;padding-top: 20px">Change Password</p>
                        <div>
                            <form class="form-a contactForm" action="${contextPath}changePassword" method="post"
                                  role="form">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-a">Change Password</button>
                                    </div>
                                </div>
                            </form>
                        </div>
